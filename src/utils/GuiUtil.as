...
public class GuiUtil {
    ...
    public static function showPopupText(view:DisplayObjectContainer, pos:Point, text:String, fontSize:uint = 20, color:uint = 0x00FF00):void{
        var tField:TextField = new TextField();
        tField.x = pos.x;
        tField.y = pos.y;
        tField.autoSize = TextFieldAutoSize.LEFT;
        tField.embedFonts = true;
        tField.defaultTextFormat = new TextFormat("myArial", fontSize);
        tField.text = text;
